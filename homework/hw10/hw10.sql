...
CREATE TABLE sentences AS
  SELECT a.first || " and " || a.second || " are " || b.size || " siblings" AS sentence FROM siblings AS a, 
  size_of_dogs AS b, size_of_dogs AS c  WHERE a.first = b.name AND a.second = c.name AND b.size = c.size;
